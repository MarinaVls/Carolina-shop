...
export const FormaOrder = ({onCloseAndClearBasket, orderPopUp, setOrderPopUp}) => {
    ...
    <Form name="complex-form" onFinish={onFinish} labelCol={{span: 8}} wrapperCol={{span: 16}} initialValues={{prefix: '375(29)'}}
            style={{width:320}}
            >
        <Form.Item label="Ваше имя" style={{marginBottom: 5}}>
            <Space>
                <Form.Item name="username" rules={[{required: true, message: 'Введите Ваше имя'}]}>
                    <Input style={{width: 230, marginBottom: 0}} placeholder="Введите Ваше имя" />
                </Form.Item>
            </Space>
        </Form.Item>
        <Form.Item label="Телефон" style={{marginBottom: 5}}>
            <Space>
        ...
        <Form.Item label="Адрес" style={{marginBottom: 5}}>
            ...
            <Form.Item name='adress' rules={[{required: true, message: 'Введите Ваш адрес'}]}
                style={{ display: 'inline-block', width: 230, marginRight:5 }}>
                <Input placeholder="Введите Ваш адрес"/>
            </Form.Item>
        </Form.Item>
        <Form.Item label=" " colon={false} style={{marginBottom: 5}}>
            <Button type="primary" htmlType="submit" 
                style={{height:35, width: 200, backgroundColor: 'rgb(27, 20, 100)', border: 'none', fontSize: 16}}>
                Оформить заказ
            </Button>
